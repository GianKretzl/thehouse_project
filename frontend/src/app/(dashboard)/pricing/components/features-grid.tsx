...
import { Rocket, Shield, Zap, Users, Headphones, Clock, BookOpen } from "lucide-react"
  ...
  return (
    <Card>
      <CardHeader className="text-center">
        <CardTitle className="text-2xl">Todos os Planos Incluem</CardTitle>
        <CardDescription>
          Recursos essenciais para manter você e sua família protegidos online
        </CardDescription>
      </CardHeader>
      <CardContent>
