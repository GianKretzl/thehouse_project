  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Você está atualmente no {plan.planName}.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-right">
            ...
            <div className="text-sm text-muted-foreground">Próxima cobrança: {plan.nextBilling}</div>
          </div>
        </div>
            ...
            <CardContent>
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <p className="font-medium text-neutral-800 dark:text-neutral-400">Precisamos da sua atenção!</p>
              ...
              <div className="mt-4 space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm text-muted-foreground font-medium">{plan.daysUsed} de {plan.totalDays} Dias</span>
                </div>
                <Progress value={plan.progressPercentage} className="h-2" />
                <p className="text-xs text-muted-foreground">{plan.remainingDays} dias restantes até que seu plano necessite atualização</p>
              </div>
            </CardContent>
          </Card>
        )}
